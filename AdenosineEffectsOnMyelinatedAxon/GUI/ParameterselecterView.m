classdef ParameterselecterView < handle
    ...
    methods
        ...
        function InitializeGUI(obj)
            ...
            set(obj.handles.stimDelayEdit, 'String', num2str(obj.controller.model.stim.delay.value));
            ...
            set(obj.handles.stimDelayUnits, 'String', obj.UnitsToString(obj.controller.model.sim.tmax.units));
            ...
            switch src.Name
                ...
                case 'lengthArray'
                    if length(unique(obj.controller.model.axon.components{1}.lengthArray(:))) > 1
                        set(obj.handles.nodeLengthEdit, 'BackgroundColor', [1, 0, 0])
                    else
                        set(obj.handles.nodeLengthEdit, 'BackgroundColor', [0, 1, 0]);
                    end
