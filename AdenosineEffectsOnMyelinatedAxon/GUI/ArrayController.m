%Modified by Lorena Arancibia to include erev array 2021-02-02
classdef ArrayController < handle
    ...
    methods
        ...
        function obj = ArrayController(parent, fullDescription)
            ...
            if any(strcmp(obj.fullDescription, {'Node Diameter', 'Node Length', 'Active Conductance', 'Number of Lamellae', 'ERev'}))
        ...
        function DisplayTable(obj)
            ...
            elseif any(strcmp(obj.fullDescription, {'Node Diameter', 'Node Length', 'Active Conductance', 'ERev'}))
                colStr = cellfun(@(x)sprintf('%i', x), num2cell(1:nCols), 'UniformOutput', false);
        ...
        function DataUpdate(obj, src, evt)
            switch obj.fullDescription
                case 'ERev'
                    if CheckValue(evt.NewData, 'real', [-inf, inf])
                        data = src.Data;
            ...
            switch obj.fullDescription
                ...
                case 'ERev'
                    obj.parent.model.node.elec.pas.leak.erev.value.vec(idx) = evt.NewData;
                    obj.parent.model.node.elec.pas.leak.erev.value.vec = ...
                        repmat(obj.parent.model.node.elec.pas.leak.erev.value.vec / obj.parent.model.geo.nnodeseg, ...
                            1, obj.parent.model.geo.nnodeseg);
                    obj.parent.model = CalculateLeakConductanceNoIh(obj.parent.model);
        ...
        function data = ReturnData(obj)
            ...
            switch obj.fullDescription
                ...
                case 'ERev'
                    data=obj.parent.model.node.elec.pas.leak.erev.value.vec;
                case 'Periaxonal Space'
                    if obj.showSegments
